...
class ApiClient {
  ...
  Future<Response> getNovelRanking(String mode, date) async {
    return httpClient.get(
      "/v1/novel/ranking?filter=for_android",
  ...
  Future<Response> getUser(int id) async {
    return httpClient.get(
      "/v1/user/detail?filter=for_android",
  ...
  Future<Response> getNext(String url) async {
    ...
    String finalUrl = url.replaceAll(
      "app-api.pixiv.net",
      a.replaceAll(a, a.replaceFirst("https://", "")),
    );
    return httpClient.get(
      finalUrl,
  ...
  Future<Response> getUserIllusts(int user_id, String type) async {
    return httpClient.get(
      "/v1/user/illusts?filter=for_android",
  ...
  Future<Response> getUserNovels(int user_id) async {
    return httpClient.get(
      "/v1/user/novels?filter=for_android",
  ...
  Future<Response> getSearchIllust(
    String word, {
    String? sort,
  ...
  Future<Response> getSearchNovel(
    String word, {
    String? sort,
    String? search_target,
    DateTime? start_date,
  ...
  Future<Response> getIllustDetail(int illust_id) {
    return httpClient.get(
      "/v1/illust/detail?filter=for_android",
  ...
  Future<Response> postIllustComment(
    int illust_id,
    String comment, {
  ...
  Future<Response> postNovelComment(
    int illust_id,
    String comment, {
    int? parent_comment_id,
  }) {
  ...
  Future<Response> illustSeries(int illustSeriesId) async {
    return httpClient.get(
      '/v1/illust/series',
      queryParameters: {'illust_series_id': illustSeriesId},
    );
  }
  ...
  Future<Response> userRestrictedModeSettings(
    bool isRestrictedModeEnabled,
  ) async {
    return httpClient.post(
      '/v1/user/restricted-mode-settings',
      data: notNullMap({"is_restricted_mode_enabled": isRestrictedModeEnabled}),
      options: Options(contentType: Headers.formUrlEncodedContentType),
    );
  }
