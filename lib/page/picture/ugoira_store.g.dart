...
mixin _$UgoiraStore on _UgoiraStoreBase, Store {
  ...
  late final _$unZipAsyncAction = AsyncAction(
    '_UgoiraStoreBase.unZip',
    context: context,
  );
  ...
  late final _$downloadAndUnzipAsyncAction = AsyncAction(
    '_UgoiraStoreBase.downloadAndUnzip',
    context: context,
  );
