...
class PhotoZoomPageEnhanced extends StatefulWidget {
  final int index;
  final Illusts illusts;
  final IllustStore illustStore;

  const PhotoZoomPageEnhanced({
    Key? key,
    required this.index,
  ...
  @override
  _PhotoZoomPageEnhancedState createState() => _PhotoZoomPageEnhancedState();
}

class _PhotoZoomPageEnhancedState extends State<PhotoZoomPageEnhanced>
  ...
  AnimationController? _doubleTapAnimation;
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    setState(() {
      ...
      _opacity = (1 - (_dragOffset.abs() / 300)).clamp(0.0, 0.0);
      _scale = (1 - (_dragOffset.abs() / 1000)).clamp(0.0, 1.0);
    });
  }
