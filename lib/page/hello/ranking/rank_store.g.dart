...
mixin _$RankStore on _RankStoreBase, Store {
  late final _$modeListAtom = Atom(
    name: '_RankStoreBase.modeList',
    context: context,
  );
  ...
  late final _$inChoiceAtom = Atom(
    name: '_RankStoreBase.inChoice',
    context: context,
  );
  ...
  late final _$saveChangeAsyncAction = AsyncAction(
    '_RankStoreBase.saveChange',
    context: context,
  );
  ...
  late final _$_RankStoreBaseActionController = ActionController(
    name: '_RankStoreBase',
    context: context,
  );
