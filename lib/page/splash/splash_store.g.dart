...
mixin _$SplashStore on _SplashStoreBase, Store {
  late final _$helloWordAtom = Atom(
    name: '_SplashStoreBase.helloWord',
    context: context,
  );
  ...
  late final _$onezeroResponseAtom = Atom(
    name: '_SplashStoreBase.onezeroResponse',
    context: context,
  );
  ...
  late final _$helloAsyncAction = AsyncAction(
    '_SplashStoreBase.hello',
    context: context,
  );
