...
abstract class AppLocalizations {
  ...
  /// No description provided for @ugoira_only.
  ///
  /// In en_US, this message translates to:
  /// **'Only Ugoira'**
  String get ugoira_only;

  /// No description provided for @ugoira_none.
  ///
  /// In en_US, this message translates to:
  /// **'No Ugoira'**
  String get ugoira_none;
  ...
  /// No description provided for @export_novel_history.
  ///
  /// In en_US, this message translates to:
  /// **'Export novel history'**
  String get export_novel_history;

  /// No description provided for @import_novel_history.
  ///
  /// In en_US, this message translates to:
  /// **'Import novel history'**
  String get import_novel_history;
  ...
  /// No description provided for @cancel_follow.
  ///
  /// In en_US, this message translates to:
  /// **'Cancel follow'**
  String get cancel_follow;

  /// No description provided for @start_follow.
  ///
  /// In en_US, this message translates to:
  /// **'Start follow'**
  String get start_follow;

  /// No description provided for @news_follow_title.
  ///
  /// In en_US, this message translates to:
  /// **'Following'**
  String get news_follow_title;

  /// No description provided for @user_page_info_title.
  ///
  /// In en_US, this message translates to:
  /// **'User info'**
  String get user_page_info_title;

  /// No description provided for @input_regexp_hint.
  ///
  /// In en_US, this message translates to:
  /// **'Enter tag name or regular expression'**
