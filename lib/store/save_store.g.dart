...
mixin _$SaveStore on _SaveStoreBase, Store {
  late final _$saveImageAsyncAction = AsyncAction(
    '_SaveStoreBase.saveImage',
    context: context,
  );

  @override
  Future<void> saveImage(Illusts illusts, {int? index, bool redo = false}) {
    return _$saveImageAsyncAction.run(
      () => super.saveImage(illusts, index: index, redo: redo),
    );
  }

  late final _$_SaveStoreBaseActionController = ActionController(
    name: '_SaveStoreBase',
    context: context,
  );
